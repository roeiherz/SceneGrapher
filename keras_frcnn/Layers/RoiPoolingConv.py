...
class RoiPoolingConv(Layer):
    ...
    def __init__(self, pool_size, num_rois, **kwargs):
        """
        :param pool_size: Size of pooling region to use. pool_size = 7 will result in a 7x7 region.
    ...
    def compute_output_shape(self, input_shape):
        """
        This function implements the output shape keras layer function
    ...
    def call(self, x, mask=None):
        ...
        :param x: list of two 4D tensors [X_img,X_roi] with shape:
                X_img:
                        (1, channels, rows, cols)` if dim_ordering='th' or
                        4D tensor with shape: (1, rows, cols, channels) if dim_ordering='tf'.
                X_roi:
