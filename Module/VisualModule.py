...
class VisualModule(object):
    ...
    def extract_features(self, R1):
        ...
        :param R1: array of relationships
    ...
    def likelihood(self, subject_ids, object_ids, predicate_ids, predicate_features, subject_probabilities, object_probabilities, z, s):
        """
